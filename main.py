...
def cat(housing):
    ...
    num_attribs = ["total_rooms", "total_bedrooms", "population", "households", "housing_median_age", "median_income", "latitude", "longitude"]
...
housing_prepared, full_pipeline = cat(housing)
...
if st.button("Predecir"):
    ...
    filter_housing = pd.DataFrame(filter)
